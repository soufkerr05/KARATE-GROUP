(function () {
    ...
    function renderNavigation() {
        ...
        mobile.innerHTML = `
            ...
            <a href="KARATE%20PROGRAM/index_4.html" class="${mobileLinkClass('KARATE PROGRAM/index_4.html')}">الحصص التدريبية</a>
